...
var _ = Describe("RouterContext", func() {
	It("should initialize correctly", func() {
		...
		rctx := NewRoutingContext(ctx, "algorithm", "model", "message", "r1", "", "default")
		...
		Expect(rctx.TenantID).To(Equal("default"))
		...
		rctx2 := NewRoutingContext(ctx2, "algorithm2", "model2", "message2", "r1", "", "default")
	...
	It("should HasRouted() indicate correctly", func() {
		ctx := NewRoutingContext(context.Background(), "algorithm", "model", "message", "r1", "", "default")
